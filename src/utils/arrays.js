...
export const services = [
    {title:"HR Planning",path:"/services/hrPlanning"},
    {title:"Job Analysis",path:"/services/jobAnalysis"},
    {title:"HR Recruitment & Selection",path:"/services/hrRecruitment"},
    {title:"Performance Management",path:"/services/performanceManagement"},
    {title:"Training and Career Development",path:"/services/training"},
    {title:"Compensation & Benefits",path:"/services/compensation"},
    {title:"Industrial Relation",path:"/services/industrialRelation"},
    {title:"HR Information System",path:"/services/hrInformationSystem"},
    {title:"Human Resource Audits",path:"/services/humanResourceAudits"},
    ];
