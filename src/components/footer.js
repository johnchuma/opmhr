const Footer = () => {
    ...
    <div>  
     <h1 className="font-bold text-white text-xl">OPM HR</h1>
    </div>
    <div>  
     <h1 className=" font-medium text-white text-md">Products</h1>
     <div className="text-lightColor mt-3">
        {[
            {title:"Software one",path:""},
            {title:"Software two",path:""},
            {title:"Software three",path:""},
            {title:"Software four",path:""},
...
<div className="flex justify-between text-lightColor mt-24">
    <p><span className="font-medium text-white">English.</span> @2024. All rights reserved</p>
